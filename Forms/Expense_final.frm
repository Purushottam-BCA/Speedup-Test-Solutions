...
Begin VB.Form FrmIncome 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   390
         Left            =   360
         MouseIcon       =   "Expense_final.frx":08CA
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   390
         Left            =   1920
         MouseIcon       =   "Expense_final.frx":0A1C
         MousePointer    =   99  'Custom
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   240
      ...
      Begin VB.CommandButton Command3 
         ...
         Height          =   390
         Left            =   3480
         MouseIcon       =   "Expense_final.frx":0B6E
         MousePointer    =   99  'Custom
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   240
      ...
      Begin VB.CommandButton Command4 
         ...
         Height          =   390
         Left            =   5040
         MouseIcon       =   "Expense_final.frx":0CC0
         MousePointer    =   99  'Custom
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   240
      ...
      Begin VB.CommandButton Command5 
         ...
         Height          =   390
         Left            =   6600
         MouseIcon       =   "Expense_final.frx":0E12
         MousePointer    =   99  'Custom
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   240
   ...
   Begin VB.TextBox n4 
      ...
      TabIndex        =   2
      Text            =   "Expense_final.frx":0F64
      Top             =   1860
      Width           =   2535
   End
   Begin MSDataGridLib.DataGrid dg1 
      Bindings        =   "Expense_final.frx":0F76
      Height          =   4455
      Left            =   0
      TabIndex        =   0
      Top             =   5040
   ...
   Begin VB.Image Image2 
      Height          =   735
      Left            =   0
      Picture         =   "Expense_final.frx":0F8B
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1155
   End
   ...
   Begin VB.Image Image1 
      Height          =   1455
      Left            =   0
      Picture         =   "Expense_final.frx":5A4B
      Stretch         =   -1  'True
      Top             =   0
      Width           =   8655
   End
...
If Trim(n2.Text) = "" Then
 MsgBox "Enter The Name From Whom Amount is Recieved..", vbCritical + vbOKOnly, ""
 n2.SetFocus
Exit Sub
ElseIf Trim(n3.Text) = "" Or Val(n3.Text) = 0 Then
 MsgBox "Enter The Amount is To be Recieved..", vbCritical + vbOKOnly, ""
 n3.SetFocus
Exit Sub
...
Exit Sub
End If
c.Execute ("insert into incm values(" & Val(n1.Caption) & ",'" & Trim(n2.Text) & "','" & Trim(n4.Text) & "'," & Val(n3.Text) & ",'" & Format(n5.Text, "dd-mmm-yyyy") & "')")
